(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["HelloWorld"] = factory(require("react"));
	else
		root["HelloWorld"] = factory(root["react"]);
...
var _PlayButton = __webpack_require__(16);

var _PlayButton2 = _interopRequireDefault(_PlayButton);

var _PauseButton = __webpack_require__(15);
    ...
    _createClass(Button, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                buttonHeight = _props.buttonHeight;


            var Icon = playing ? _react2.default.createElement(_PauseButton2.default, { color: color, width: buttonWidth, height: buttonHeight }) : _react2.default.createElement(_PlayButton2.default, { color: color, width: buttonWidth, height: buttonHeight });

            return _react2.default.createElement(
                'a',
                { href: '#', className: 'circle-player-button', onClick: onClick },
                Icon
            );
        }
    }]);
...
var Controls = function (_Component) {
	...
	_createClass(Controls, [{
		...
		value: function render() {
			...
			var buttonWidth = parseInt(this.props.width * 0.5);
			var buttonHeight = parseInt(this.props.height * 0.5);
			var halfWidth = -parseInt(buttonWidth / 2);
			var halfHeight = -parseInt(buttonHeight / 2);
			...
			return _react2.default.createElement(
				'div',
				{ className: 'circle-player-controls' },
...
var _defaultCover = __webpack_require__(20);

var _defaultCover2 = _interopRequireDefault(_defaultCover);
...
var Cover = function (_Component) {
    ...
    _createClass(Cover, [{
        key: 'render',
        value: function render() {
            var coverImage = _react2.default.createElement(_Image2.default, { src: _defaultCover2.default });

            if (this.props.src) {
                coverImage = _react2.default.createElement(_Image2.default, { src: this.props.src });
            }

            return _react2.default.createElement(
                'div',
                { className: 'circle-player-cover' },
                coverImage
            );
        }
    }]);
...
var SpotifyManager = function (_Component) {
    _inherits(SpotifyManager, _Component);

    function SpotifyManager(props) {
        _classCallCheck(this, SpotifyManager);

        var _this = _possibleConstructorReturn(this, (SpotifyManager.__proto__ || Object.getPrototypeOf(SpotifyManager)).call(this, props));

        _this.getSpotifyTrack = _this.getSpotifyTrack.bind(_this);
        return _this;
    }

    _createClass(SpotifyManager, [{
        key: 'getSpotifyTrack',
        value: function getSpotifyTrack() {
            var _props = this.props,
                spotifyWebAPIURL = _props.spotifyWebAPIURL,
                spotifyTrackId = _props.spotifyTrackId,
                spotifyToken = _props.spotifyToken;
            ...
            return fetch(spotifyWebAPIURL + '/tracks/' + spotifyTrackId, fetchOptions).then(function (response) {
        ...
        value: function componentDidMount() {
            ...
            if (this.props.spotifyTrackId != "") {
                if (this.props.spotifyToken == "") {
                    ...
                    this.getSpotifyTrack().then(function (track) {
                        console.log(track);
                        var cover = track.album.images[0].url;
                        var src = track.preview_url;

                        _this2.props.setPlayerData(src, cover);
                    }).catch(function (err) {
                        console.error(err);
                    });
                }
...
var PauseButton = function (_Component) {
    ...
    function PauseButton(props) {
        ...
        return _possibleConstructorReturn(this, (PauseButton.__proto__ || Object.getPrototypeOf(PauseButton)).call(this, props));
    }
...
var _Cover = __webpack_require__(10);

var _Cover2 = _interopRequireDefault(_Cover);

var _SpotifyManager = __webpack_require__(11);
...
var CirclePlayer = function (_Component) {
  _inherits(CirclePlayer, _Component);

  function CirclePlayer(props) {
    _classCallCheck(this, CirclePlayer);

    var _this = _possibleConstructorReturn(this, (CirclePlayer.__proto__ || Object.getPrototypeOf(CirclePlayer)).call(this, props));
    ...
    _this.setAudioEl = _this.setAudioEl.bind(_this);
    _this.setPlayerData = _this.setPlayerData.bind(_this);
    _this.onChange = _this.onChange.bind(_this);
    _this.onPlay = _this.onPlay.bind(_this);
    _this.onPause = _this.onPause.bind(_this);
    _this.onEnded = _this.onPause.bind(_this);
    return _this;
  }

  _createClass(CirclePlayer, [{
    key: 'setPlayerData',
    value: function setPlayerData(src, cover) {
      this.setState({
        playerSrc: src,
        playerCover: cover
      });
    ...
    value: function render() {
      ...
      var circlePlayerCN = (0, _classnames2.default)("circle-player", playing ? 'is-playing' : 'is-paused');

      return _react2.default.createElement(
        'div',
        { className: circlePlayerCN,
          style: {
            width: width + 'px',
            height: height + 'px',
        ...
        _react2.default.createElement(_SpotifyManager2.default, {
...
CirclePlayer.propTypes = {
  ...
  cover: _propTypes2.default.element,
  ...
  spotifyTrackId: _propTypes2.default.string,
  spotifyToken: _propTypes2.default.string,
  spotifyWebAPIURL: _propTypes2.default.string,
...
// module
exports.push([module.i, ".circle-player {\n\tborder-radius: 10%;\n\toverflow: hidden;\n\tposition: relative;\n\tcursor: pointer;\n}\n\n.circle-player.is-playing {\n\tborder-radius: 100%;\n}\n\n.circle-player, .circle-player * {\n\t-webkit-transition: all 0.3s ease-out;\n\ttransition: all 0.3s ease-out;\n}\n\n.circle-player.is-playing {\n\tborder-radius: 100%;\n}\n\n.circle-player.is-playing .circle-player-cover {\n\tanimation: rotating 3s infinite linear;\n\tanimation-fill-mode: forwards;\n}\n\n.circle-player-cover {\n\tdisplay: flex;\n\tjustify-content: center;\n\talign-items: center;\n\theight: 100%;\n}\n\n.circle-player .circle-player-cover img {\n\tmax-width: 200%;\n}\n\n.circle-player:hover .circle-player-cover img{\n\ttransform: scale(0.7);\n}\n\n.circle-player-controls {\n\tposition: absolute;\n\theight: 100%;\n\tz-index: 1;\n\ttop: 0;\n\tleft: 0;\n\tright: 0;\n\tbottom: 0;\n\topacity: 0;\n\t-webkit-transition: all 0.3s ease-out;\n\ttransition: all 0.3s ease-out;\n\ttransform: scale(0.7)\n}\n\n.circle-player:hover .circle-player-controls {\n\topacity: 1;\n\ttransform: scale(1)\n}\n\n.circle-player:hover .circle-player-controls svg {\n\t-webkit-transition: none;\n\ttransition: none;\n}\n\n.circle-player-button {\n\tposition: absolute;\n\ttop: 50%;\n\tleft: 50%;\n}\n\n@-webkit-keyframes rotating {\n  from {\n    -webkit-transform: rotate(0deg);\n    -o-transform: rotate(0deg);\n    transform: rotate(0deg);\n  }\n  to {\n    -webkit-transform: rotate(360deg);\n    -o-transform: rotate(360deg);\n    transform: rotate(360deg);\n  }\n}\n@keyframes rotating {\n  from {\n    -ms-transform: rotate(0deg);\n    -moz-transform: rotate(0deg);\n    -webkit-transform: rotate(0deg);\n    -o-transform: rotate(0deg);\n    transform: rotate(0deg);\n  }\n  to {\n    -ms-transform: rotate(360deg);\n    -moz-transform: rotate(360deg);\n    -webkit-transform: rotate(360deg);\n    -o-transform: rotate(360deg);\n    transform: rotate(360deg);\n  }\n}", ""]);
...
module.exports = __webpack_require__.p + "f23d97a91cececaaf4cfbe5b6af58ee7.png";
